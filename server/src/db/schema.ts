...
const statements = [
  `CREATE TABLE IF NOT EXISTS stations (
    ...
    auto_clock_out_enabled INTEGER NOT NULL DEFAULT 1,
    auto_clock_out_time TEXT NOT NULL DEFAULT '22:45',
  ...
  `CREATE TABLE IF NOT EXISTS employees (
    ...
    planning_notes TEXT,
    desired_shifts_per_month INTEGER,
    min_shifts_per_month INTEGER,
    max_shifts_per_month INTEGER,
    desired_weekends_per_month INTEGER,
    weekend_day_preference TEXT DEFAULT 'either',
    preferred_shift_policy TEXT DEFAULT 'any',
  ...
  `CREATE TABLE IF NOT EXISTS time_entries (
    ...
    early_leave_note TEXT,
    early_leave_confirmed_at TEXT,
    early_leave_confirmed_by_employee_id TEXT,
    created_at TEXT,
    updated_at TEXT,
    FOREIGN KEY (station_id) REFERENCES stations(id),
    FOREIGN KEY (employee_id) REFERENCES employees(id)
  ...
  `CREATE INDEX IF NOT EXISTS idx_time_entry_corrections_entry ON time_entry_corrections(time_entry_id)`,
  `CREATE INDEX IF NOT EXISTS idx_time_entry_corrections_station_created ON time_entry_corrections(station_id, created_at)`,
  ...
  `CREATE TABLE IF NOT EXISTS backshop_routines (
    id TEXT PRIMARY KEY,
    station_id TEXT NOT NULL,
    ...
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL,
    UNIQUE(station_id, routine_type),
    FOREIGN KEY (station_id) REFERENCES stations(id)
  )`,
  `CREATE INDEX IF NOT EXISTS idx_backshop_routines_station ON backshop_routines(station_id)`,
  `CREATE TABLE IF NOT EXISTS backshop_routine_items (
    id TEXT PRIMARY KEY,
    ...
    valid_from TEXT,
    valid_to TEXT,
    restrict_day_type TEXT,
    notes TEXT,
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL,
    FOREIGN KEY (routine_id) REFERENCES backshop_routines(id) ON DELETE CASCADE
  )`,
  `CREATE INDEX IF NOT EXISTS idx_backshop_routine_items_routine ON backshop_routine_items(routine_id)`,
  `CREATE TABLE IF NOT EXISTS backshop_notice_acknowledgements (
    id TEXT PRIMARY KEY,
    station_id TEXT NOT NULL,
    employee_id TEXT NOT NULL,
    shift_id TEXT,
  ...
  `CREATE INDEX IF NOT EXISTS idx_backshop_ack_station ON backshop_notice_acknowledgements(station_id)`,
  `CREATE INDEX IF NOT EXISTS idx_backshop_ack_employee ON backshop_notice_acknowledgements(employee_id)`,
  `CREATE TABLE IF NOT EXISTS task_templates (
    ...
    frequency_type TEXT,
    applies_every_shift INTEGER DEFAULT 0,
    applies_early_shift INTEGER DEFAULT 1,
    applies_late_shift INTEGER DEFAULT 1,
    weekend_sat_only INTEGER DEFAULT 0,
    weekend_sun_only INTEGER DEFAULT 0,
    applies_to_weekdays_json TEXT,
    only_weekend INTEGER DEFAULT 0,
    is_required INTEGER DEFAULT 0,
    required_for_shift_close INTEGER DEFAULT 0,
    remark_required_if_not_done INTEGER DEFAULT 0,
    dynamic_assignment INTEGER DEFAULT 0,
    max_per_year INTEGER,
    max_per_month INTEGER,
    max_per_week INTEGER,
    tasks_per_shift INTEGER,
    active INTEGER DEFAULT 1,
    ...
    archived_at TEXT,
    FOREIGN KEY (station_id) REFERENCES stations(id) ON DELETE CASCADE,
    UNIQUE (station_id, template_key)
  )`,
  `CREATE INDEX IF NOT EXISTS idx_task_templates_station_type ON task_templates(station_id, template_type, active, sort_order)`,
