...
export type BakingNoticePayload = {
  timeEntryId: string
  planType: 'weekday' | 'weekend_holiday' | string
  items: string[]
}
  ...
  return (
    <div className="fixed inset-0 z-[160] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
      ...
      >
        ...
        <p className="mt-4 text-sm font-medium text-[var(--text-main)]">Backwaren heute:</p>
        ...
        <textarea
          ...
          placeholder="Falls Brötchen, Brezeln oder Patties fehlen, bitte hier eintragen…"
