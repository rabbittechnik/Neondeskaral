...
export function OpenShiftBlock({ item, headerOffsetPx, layout, onSelect }: Props) {
  ...
  return (
    <button
      ...
      className="group absolute z-[2] min-w-[40px] overflow-hidden rounded-xl border-2 border-orange-200/90 px-2 py-1 text-left text-white transition-[box-shadow,filter] duration-150 hover:z-[3] hover:brightness-110 hover:shadow-[0_0_32px_rgba(251,146,60,0.85)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-200 sm:min-w-[48px] sm:px-2.5 sm:py-1.5"
    >
      {narrow ? (
